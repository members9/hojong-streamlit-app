...
for msg in st.session_state.chat_messages:
    if msg["role"] == "user":
        ...
        <div style='text-align: left;'>
            <div style='display: inline-block; background-color: #FFEB3B; color: #000000; padding: 10px 14px; border-radius: 12px 0px 12px 12px; margin: 6px 0; max-width: 66%;'>
        ...
        st.markdown(f"""
        <div style='text-align: left;'>
            <div style='display: inline-block; background-color: #F1F1F1; color: #000000; padding: 10px 14px; border-radius: 0px 12px 12px 12px; margin: 6px 0; max-width: 66%;'>
                {msg["content"].replace(chr(10), "<br>")}
            </div>
        </div>
        """, unsafe_allow_html=True)
